...
$html = <<<EOT
  ...
  <p>This sample demonstrates how to upload files directly to VWflow. This is done using the 'items-hmac-redirect' API endpoint and HMAC authentication.</p>

    <form id="MyForm" action="https:///workflow.workflow02.rambla.be/api/v1/items-hmac-redirect/$account_id/$workflow_profile_id/" enctype="multipart/form-data" method="POST">
    <fieldset>
